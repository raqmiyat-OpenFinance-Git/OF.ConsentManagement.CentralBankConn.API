...
using OF.ConsentManagement.CentralBankConn.API.API;
using OF.ConsentManagement.CentralBankConn.API.Middleware;
...
namespace OF.ConsentManagement.CentralBankConn.API;

public static class Program
{
    private static readonly Logger _logger = LogManager.GetLogger("OF.ConsentManagement.CentralBankConn.APILogger");

    public static async Task Main(string[] args)
    {
        var builder = WebApplication.CreateBuilder(args);

        const string AllowSpecificOrigins = "OF.ConsentManagement.CentralBankConn.API";
        ...
        if (redisSettings!.EnableCache)
        {
            builder.Services.AddStackExchangeRedisCache(options =>
            {
                ...
                options.InstanceName = "ConsentEventService";
            });
        }
    ...
    {
        services.AddHttpClient<IConsentManagementService, ConsentManagementService>((provider, client) =>
        {
